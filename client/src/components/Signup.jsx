import {Button,Checkbox,Form,Input, Col, Row, Switch, Radio} from 'antd';
...
import { toast, ToastContainer } from 'react-toastify';
  ...
  const SignUp = ({ setSeller }) => {
    ...
    <div className='container-fluid' style={{ height: '100%', margin: '30px 0' }}>
        <div className="block aboutBlock">
            <div className="titleHolder" style={{ marginTop: '40px' }}>
                SignUp Form
            </div>
            <div className='registerDesktopShow'>
                        ...
                        <div style={{ padding: '32px 24px', backgroundColor: '#F5F5F5' }}>
                            ...
                            >
                                <Input />
                                                ...
                                                <label>Are you a <strong>buyer</strong> or a <strong>seller</strong>?</label>
                                                <Radio.Group name="radiogroup" defaultValue={status} onChange={(e)=>setStatus(e.target.value)}>
                                                    <Radio value={false}>Buyer</Radio>
                                                    <Radio value={true}>Seller</Radio>
                                                </Radio.Group>
                                                <br/><br/>
            ...
            <div className='registerMobileShow'>
                <Row gutter={{ xs: 8, sm: 16, md: 24}} justify='space-evenly' align='middle' style={{ width: '100%', marginRight: 'auto', marginLeft: 'auto' }}>
                    {/* <Col span={6}>
                        <div>
