            ...
            <div id='sell' className='block worksBlock'>
                <div className='container-fluid'>
                    <div className='titleHolder' style={{ color: '#fff', textAlign: 'center', fontFamily: 'Nunito'}}>
                        ...
                        <Button onClick={()=>navigate(`/seller-home`)} style={{ backgroundColor: '#fff', border: 'none', color: '#100d10', borderRadius: '5px', width: '150px', fontFamily: 'Nunito', fontWeight: '700'  }}>Add product</Button>
                    </div>
                </div>
            </div>
        )
