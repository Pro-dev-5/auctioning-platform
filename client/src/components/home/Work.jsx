            ...
            <div id='sell' className='block worksBlock'>
                <div className='container-fluid'>
                    <div className='titleHolder' style={{ color: '#fff', textAlign: 'center', fontFamily: 'Nunito'}}>
                        ...
                        <Button onClick={()=>navigate(`/sellerhome/${seller?.id}`)} style={{ backgroundColor: '#fff', border: 'none', color: '#100d10', borderRadius: '5px', width: '150px', fontFamily: 'Nunito', fontWeight: '700'  }}>See Your Products</Button>
                    </div>
                </div>
            </div>
        )
